...
const inningSchema =new mongoose.Schema({
  ...
  striker:{type: mongoose.Schema.Types.ObjectId, ref: "Batsman"},
  nonStriker:{type: mongoose.Schema.Types.ObjectId, ref: "Batsman"},
  bowler:{ type: mongoose.Schema.Types.ObjectId, ref: "Bowler" },
  over:{ type: mongoose.Schema.Types.ObjectId, ref: "Over" },
  overs: [{ type: mongoose.Schema.Types.ObjectId, ref: "Over" }], // Array of overs in the innings
  currentOverNumber: { type: Number, default: 0 },
  currentBallNumber: { type: Number, default: 0 }, // 1-6 per over
